#include <string>
#include "sentry_behavior_tree/plugins/service/rmuc_enemy_patrol_service.hpp"

namespace sentry_behavior_tree{

    RmucEnemyPatrolService::RmucEnemyPatrolService(const std::string & service_node_name,
    ...
    BT::NodeStatus RmucEnemyPatrolService::check_future(
...
{
  factory.registerNodeType<sentry_behavior_tree::RmucEnemyPatrolService>(
    "RmucEnemyPatrol");
    //注意这里""内没有Service 
}