#include <string>
#include "sentry_behavior_tree/plugins/service/rmuc_base_patrol_service.hpp"

namespace sentry_behavior_tree{

    RmucBasePatrolService::RmucBasePatrolService(const std::string & service_node_name,
        const BT::NodeConfiguration & conf)
        : nav2_behavior_tree::BtServiceNode<sentry_srvs::srv::NavGoal>(service_node_name, conf){}

    void RmucBasePatrolService::on_tick()
    {
...
{
  factory.registerNodeType<sentry_behavior_tree::RmucBasePatrolService>(
    "RmucBasePatrol");
    //注意这里""内没有Service 
}